...
\begin{itemize}
\item GDP = \$30.8 Trillion (2025, annual, nominal)
\item US Population = 343 million (January 2026, est.)
\item World Population = 8.2 billion (January 2026, est.)
\item Unemployment Rate = 4.3 (Apr 2026)
\item Inflation = 3.8 (CPI-all items, Apr 2025 - Apr 2026)
\item Core inflation = 2.7 (CPI-all items less food and energy, Apr 2025 - Apr 2026)
...
\resizebox{\textwidth}{.5\textheight}{\input{circular_flow_simple.tex}}
\end{column}
...
\begin{itemize}
\item Nominal GDP in \lastyear -- \$30.8 T
\item Nominal GDP in \baseyear -- \$19.6 T

\item Real GDP in \lastyear -- \$23.9 T (in \baseyear \$)
\item Real GDP in \baseyear -- \$19.6 T (in \baseyear \$)
\vspace{11pt}
\item The nominal increase was \$11.2 T
\item The real increase was \$4.3 T
\item The increase due to inflation was \$6.9 T
\end{itemize}
...
\begin{wideitemize}
\item $NGDP_{\lastyearshort}$ = \$30.8 T
\item $RGDP_{\lastyearshort}$ = \$23.9 T (\baseyear\$)
\item $GDPD = NGDP/RGDP$ = 1.290
\item Prices rose by about 29.0\% between \baseyear \  and \lastyear
\end{wideitemize}
\end{frame}
...
\centering\includegraphics[height = .9\textheight]{PNC_12days.png}
\end{frame}
...
\centering\includegraphics[height = \textheight]{LSAT2024.pdf}
\end{frame}
